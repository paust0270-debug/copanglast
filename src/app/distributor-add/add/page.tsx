...
import { addDistributor, checkDistributorsTable } from '@/lib/supabase';
...
export default function AddDistributorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('총판이 성공적으로 등록되었습니다.');
      router.push('/distributor-add');
    } catch (error) {
      console.error('총판 추가 실패:', error);
      alert('총판 추가에 실패했습니다. 다시 시도해주세요.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="content-wrapper">
        <div className="container mx-auto p-6">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">총판추가</h1>
            <p className="text-gray-600">새로운 총판 정보를 입력해주세요.</p>
          </div>

          <Card>
            <CardHeader>
              <CardTitle className="text-xl">총판 정보 입력</CardTitle>
            </CardHeader>
            <CardContent>
