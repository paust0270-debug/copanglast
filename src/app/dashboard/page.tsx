    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <div className="relative">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-600 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform">
                <span className="text-white text-3xl font-black tracking-tight">
                  AD
                </span>
              </div>
              <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full animate-pulse"></div>
            </div>

            {/* 애드팡팡 텍스트 */}
            <h1 className="text-5xl font-black bg-gradient-to-r from-purple-600 via-purple-500 to-pink-500 bg-clip-text text-transparent pb-1">
              애드팡팡
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {/* 무료 서비스 */}
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl shadow-lg p-8 border border-green-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">무료 서비스</h3>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Link
            href="/customer"
            className="group relative bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-blue-200 overflow-hidden"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
                  <svg
          ...
          <Link
            ...
            className="group relative bg-gradient-to-br from-green-50 to-green-100 rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-green-200 overflow-hidden"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
                  <svg
                    className="w-7 h-7 text-white"
                    fill="none"
                    stroke="currentColor"
          ...
          <Link
            href="/admin/slots"
            className="group relative bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-purple-200 overflow-hidden"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
                  <svg
                    className="w-7 h-7 text-white"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg font-medium group-hover:bg-purple-700 transition-colors">
                이동 →
              </div>
            </div>
          </Link>
          ...
          <Link
            href="/slot-status"
            className="group relative bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-orange-200 overflow-hidden"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
                  <svg
                    className="w-7 h-7 text-white"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg font-medium group-hover:bg-orange-700 transition-colors">
                이동 →
              </div>
            </div>
          </Link>
        ...
        {!isRegularUser && (
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link
                href="/ranking-status"
                className="group relative bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-indigo-200 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
                      <svg
                        className="w-7 h-7 text-white"
                        fill="none"
                        stroke="currentColor"
                  ...
                  <div className="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg font-medium group-hover:bg-indigo-700 transition-colors">
                    순위체크현황 보기
                  </div>
                </div>
              </Link>
              ...
              <Link
                href="/traffic-status"
                className="group relative bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-cyan-200 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
                      <svg
                        className="w-7 h-7 text-white"
                        fill="none"
                        stroke="currentColor"
                  ...
                  <div className="inline-flex items-center px-4 py-2 bg-cyan-600 text-white rounded-lg font-medium group-hover:bg-cyan-700 transition-colors">
                    트래픽현황 보기
                  </div>
                </div>
              </Link>
        ...
        {/* 최신 공지사항 */}
        <div className="relative bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl shadow-lg p-8 mb-12 border border-blue-200 overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="group relative bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-md p-6 text-center border border-blue-200 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-gray-700 font-medium">전체 사용자</div>
            </div>
          </div>
          <div className="group relative bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-md p-6 text-center border border-green-200 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-gray-700 font-medium">활성 슬롯</div>
            </div>
          </div>
          <div className="group relative bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-md p-6 text-center border border-purple-200 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-4xl font-black text-purple-600 mb-2 group-hover:scale-110 transition-transform">
                342
              </div>
              <div className="text-gray-700 font-medium">추적 상품</div>
            </div>
          </div>
          <div className="group relative bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl shadow-md p-6 text-center border border-indigo-200 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-gray-700 font-medium">성공 체크</div>
            </div>
          </div>
          <div className="group relative bg-gradient-to-br from-red-50 to-red-100 rounded-xl shadow-md p-6 text-center border border-red-200 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-4xl font-black text-red-600 mb-2 group-hover:scale-110 transition-transform">
                23
              </div>
              <div className="text-gray-700 font-medium">실패 체크</div>
            </div>
          </div>
          <div className="group relative bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl shadow-md p-6 text-center border border-pink-200 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-4xl font-black text-pink-600 mb-2 group-hover:scale-110 transition-transform">
                715ms
              </div>
              <div className="text-gray-700 font-medium">평균 응답시간</div>
            </div>
          </div>
        </div>
      </div>
