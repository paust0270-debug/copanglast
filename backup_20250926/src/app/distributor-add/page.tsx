...
import { getDistributors, deleteDistributor, Distributor, checkDistributorsTable } from '@/lib/supabase';
        ...
        <div className="content-wrapper">
          <div className="container mx-auto p-2 pt-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600">총판 정보를 관리하고 새로운 총판을 추가할 수 있습니다.</p>
            </div>
                ...
                <div className="text-center">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                    ...
                    <ol className="text-sm text-yellow-700 space-y-1">
                      ...
                      <li>2. create-distributors-table.sql 파일의 내용을 복사하여 실행하세요</li>
      ...
      <div className="content-wrapper">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">총 총판 수</p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">활성 총판</p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">본사 총판</p>
                    <p className="text-2xl font-bold text-gray-900">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button onClick={handleAddDistributor} className="bg-blue-600 hover:bg-blue-700">
                       ...
                       {distributors.map((distributor, index) => (
                         <tr key={distributor.id} className="hover:bg-gray-50">
                           ...
                           <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                              {distributor.domain || '-'} / {distributor.ip || '-'}
                            </td>
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                              <div className="max-w-xs truncate" title={distributor.memo || ''}>
                                {distributor.memo || '-'}
                              </div>
                            </td>
