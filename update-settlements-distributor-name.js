...
async function updateSettlementsDistributorName() {
  console.log('🔧 settlements 테이블 distributor_name을 총판B로 업데이트');
  console.log('============================================================');
  ...
  try {
    ...
    // 2. 모든 settlements의 distributor_name을 "총판B"로 업데이트
    console.log('\n2️⃣ settlements distributor_name 업데이트...');
    ...
    if (updateError) {
      console.error('❌ settlements distributor_name 업데이트 오류:', updateError);
    } else {
      console.log('✅ settlements distributor_name 업데이트 성공!');
    }

    // 3. settlement_history의 distributor_name도 "총판B"로 업데이트
    console.log('\n3️⃣ settlement_history distributor_name 업데이트...');
    ...
    if (historyUpdateError) {
      console.error('❌ settlement_history distributor_name 업데이트 오류:', historyUpdateError);
    } else {
      console.log('✅ settlement_history distributor_name 업데이트 성공!');
    }
...
updateSettlementsDistributorName();
